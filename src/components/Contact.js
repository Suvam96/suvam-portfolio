...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create API endpoint in Next.js to send email
          ...
          <div className="md:w-1/3">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">96suvam@gmail.com</p>
              </div>
          ...
          <div className="md:w-2/3">
            <form onSubmit={handleSubmit} className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              {submitStatus.message && (
                <div className={`mb-6 p-3 rounded-md ${submitStatus.success ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                  {submitStatus.message}
                </div>
              )}
